...
function IconWrap({ children }: { children: ReactNode }) {
  return h('span', { className: 'block h-10 w-10' }, children);
}
...
export const tapeIcons: Record<string, ReactNode> = {
  TypeScript: IconWrap({
    children: h(
      ...
      h('rect', { x: 2, y: 2, width: 20, height: 20, rx: 4, fill: '#3178C6' }),
      h('path', {
  ...
  JavaScript: IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('rect', { x: 2, y: 2, width: 20, height: 20, rx: 4, fill: '#F7DF1E' }),
      h('path', {
  ...
  HTML: IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('path', { d: 'M4 3h16l-1.5 17L12 22l-6.5-2L4 3Z', fill: '#E34F26' }),
      h('path', { d: 'M12 20.3 17.3 18.7 18.6 4.7H12v15.6Z', fill: '#EF652A' }),
      h('path', {
  ...
  CSS: IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('path', { d: 'M4 3h16l-1.5 17L12 22l-6.5-2L4 3Z', fill: '#1572B6' }),
      h('path', { d: 'M12 20.3 17.3 18.7 18.6 4.7H12v15.6Z', fill: '#1B83C1' }),
      h('path', {
  ...
  React: IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('circle', { cx: 12, cy: 12, r: 2.2, fill: '#149ECA' }),
      h(
        'g',
        { fill: 'none', stroke: '#149ECA', strokeWidth: 1.6 },
        h('ellipse', { cx: 12, cy: 12, rx: 9, ry: 3.6 }),
        h('ellipse', { cx: 12, cy: 12, rx: 3.6, ry: 9, transform: 'rotate(60 12 12)' }),
        h('ellipse', { cx: 12, cy: 12, rx: 3.6, ry: 9, transform: 'rotate(120 12 12)' })
      )
    ),
  }),
  'Next.js': IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('circle', { cx: 12, cy: 12, r: 10, fill: '#0B0B0C' }),
      h('path', {
  ...
  Java: IconWrap({
    children: h(
      ...
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('path', {
        d: 'M8.3 16.6c.1 1.2 2 2.2 4.3 2.2 2.6 0 4.7-1 4.7-2.3 0-.8-.8-1.3-2-1.7.7.5 1 .9 1 1.3 0 1-1.7 1.8-3.8 1.8-1.9 0-3.5-.7-4.2-1.3Z',
        fill: '#EA580C',
      }),
      h('path', { d: 'M10.2 5.4c1.2 1.5-.4 2.8-.4 2.8s2.9-1.4.4-2.8Z', fill: '#2563EB' }),
      h('path', { d: 'M12.2 4c1.4 1.7-.5 3.2-.5 3.2s3.3-1.6.5-3.2Z', fill: '#2563EB' }),
      h('path', { d: 'M14.3 5c1.1 1.5-.5 2.8-.5 2.8s3-1.4.5-2.8Z', fill: '#2563EB' }),
      h('path', {
        d: 'M7.3 13.6c0-1.6 2.2-2.9 4.9-2.9 1.5 0 2.9.4 3.7 1-.8-.9-2.3-1.5-4-1.5-2.8 0-5 1.5-5 3.4 0 1.1.8 2 2.1 2.6-1.1-.7-1.7-1.6-1.7-2.6Z',
        fill: '#111827',
        fillOpacity: '0.9',
      })
    ),
  ...
  Spring: IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('circle', { cx: 12, cy: 12, r: 9, fill: '#16A34A' }),
      h('path', {
  ...
  Flutter: IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('path', { d: 'M14.6 3.6 4.7 13.5l2.7 2.7L20 3.6h-5.4Z', fill: '#42A5F5' }),
      h('path', { d: 'M10.6 17.6 4.7 23.5h5.4l3.2-3.2-2.7-2.7Z', fill: '#0D47A1' }),
      h('path', { d: 'M13.3 20.3 20 13.6h-5.4l-4 4 2.7 2.7Z', fill: '#1E88E5' })
    ),
  }),
  MySQL: IconWrap({
    children: h(
      ...
      h('path', {
        d: 'M9.2 7.6c.7-1.5 2.2-2.5 4-2.5 1.2 0 2.2.4 3 1.1-1-.4-2.2-.2-3.1.4 1.2-.3 2.2 0 2.9.7.8.8.8 2 0 3.1.4-1.2 0-2.3-.8-2.9-.7-.5-1.6-.5-2.5.1-1.3.9-1.8 2.4-1.5 4.1-.6-1.3-.7-2.8 0-4.1Z',
        fill: '#F59E0B',
      })
    ),
  }),
  SQL: IconWrap({
    children: h(
      'svg',
      { viewBox: '0 0 24 24', 'aria-hidden': 'true' },
      h('ellipse', { cx: 12, cy: 7, rx: 7, ry: 3, fill: '#64748B' }),
      h('path', { d: 'M5 7v4c0 1.7 3.1 3 7 3s7-1.3 7-3V7', fill: '#94A3B8' }),
      h('path', { d: 'M5 11v4c0 1.7 3.1 3 7 3s7-1.3 7-3v-4', fill: '#CBD5E1' }),
      h('path', { d: 'M5 15v2c0 1.7 3.1 3 7 3s7-1.3 7-3v-2', fill: '#E2E8F0' })
    ),
  }),
};
